  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: const Color.fromARGB(255, 63, 53, 79),
      ),
      body: Padding(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color.fromARGB(255, 66, 56, 83), width: 1),
          boxShadow: [
            BoxShadow(
              color: const Color.fromARGB(255, 73, 58, 99).withOpacity(0.1),
              blurRadius: 6,
              offset: Offset(0, 3),
            ),
          ],
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: const Color.fromARGB(255, 63, 54, 78),
              ),
